...
/*
************************************************************
*******************@PHP PDO By mytepper@gmail.com Contact****
************************************************************
*/
class PDO_db extends PDO
{
    private $_fetchMode = PDO::FETCH_ASSOC;
    //private $_fetchMode_obj = PDO::FETCH_OBJ; //Set Mode fetch
...
/*
*@Config Contact to Server
*/

$db = new PDO_db('mysql:dbname=phonebook_db;host=localhost;charset=UTF8', 'root', '');
/*
